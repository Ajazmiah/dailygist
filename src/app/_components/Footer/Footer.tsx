    ...
    <footer className="bg-red-600 text-white">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="w-full mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            {/* <div className="col-span-2">
              <div>
                <h1 className="text-3xl font-bold">Get the latest news!</h1>
              </div>
            </div> */}
{/* FORM----------------------------------------------------------------------
              ...
              <form className="w-full">
                ...
                <div className=" p-2  sm:flex sm:items-center sm:gap-4">
                  <input
                    ...
                    className=" w-full border-none p-4 text-black sm:text-sm"
                  />
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs">
              &copy; 2024. Dailygist. All rights reserved.
            </p>
